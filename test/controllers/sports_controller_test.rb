...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference("Sport.count") do
      post sports_url, params: { sport: { age: @sport.age, course: @sport.course, gender: @sport.gender, name: @sport.name } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { age: @sport.age, course: @sport.course, gender: @sport.gender, name: @sport.name } }
